...
export type RemoveToCardCmd = Action<CART_ACTIONS.REMOVE_ITEM> & { payload: Item }
export type DecreateQuantityCmd = Action<CART_ACTIONS.REDUCEQUANTITY> & { payload: Item }
export type CartCmd = ToggleCardCmd & AddToCardCmd & RemoveToCardCmd & DecreateQuantityCmd;
