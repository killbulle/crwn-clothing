...
import {CART_ACTIONS, createAddToCardCmd, createDecreateQuantityCmd, removeToCardCmd,} from '../../redux/Cart/action';
...
interface DispatchProps {
    ...
    reduce: (
        item: Item
    ) => Action<CART_ACTIONS.REDUCEQUANTITY> & { payload: Item };
...
const Checkoutitem = ({
    ...
    <div className="checkout-item">
        ...
        <span className="decrease" onClick={() => reduce(item)}>
      {'<'}
    </span>
