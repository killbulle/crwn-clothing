...
class SignUp extends React.Component<Props, SignUpState> {
    ...
    private onchange = (e: React.ChangeEvent<HTMLInputElement>) => {
      ...
      this.setState({
        [name]: value,
      } as Pick<SignUpState, keyof SignUpState>, () => console.log(this.state));
    }
    ...
    private submit = async (e: React.FormEvent<HTMLFormElement>) => {
      ...
      const {
        confirmPasword, password, displayname, email,
      } = this.state;
      ...
      return (
        <div className="sign-up">
          ...
          <form className="sign-up-form" onSubmit={this.submit}>
            ...
            />
            <Forminput type="email" name="email" label="email" value={email} required onChange={this.onchange} />
            <Forminput
              type="password"
              name="password"
              label="password"
